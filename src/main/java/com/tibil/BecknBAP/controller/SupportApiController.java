...
import com.tibil.BecknBAP.controller.api.SupportApi;
import com.tibil.BecknBAP.dto.beckn.InlineResponse200;
import com.tibil.BecknBAP.dto.beckn.SupportBody;
...
public class SupportApiController implements SupportApi {
    ...
    public ResponseEntity<InlineResponse200> supportPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody SupportBody body) {
