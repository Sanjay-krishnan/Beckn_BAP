...
import com.tibil.BecknBAP.controller.api.StatusApi;
import com.tibil.BecknBAP.dto.beckn.InlineResponse200;
import com.tibil.BecknBAP.dto.beckn.StatusBody;
import com.tibil.BecknBAP.dto.internal.Status;
...
public class StatusApiController implements StatusApi {
    ...
    public ResponseEntity<InlineResponse200> statusPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody Status body) {
