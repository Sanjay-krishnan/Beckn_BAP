...
import com.tibil.BecknBAP.controller.api.OnSelectApi;
import com.tibil.BecknBAP.dto.beckn.InlineResponse200;
import com.tibil.BecknBAP.dto.beckn.OnSelectBody;
...
public class OnSelectApiController implements OnSelectApi {
    ...
    public ResponseEntity<InlineResponse200> onSelectPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody OnSelectBody body) {
