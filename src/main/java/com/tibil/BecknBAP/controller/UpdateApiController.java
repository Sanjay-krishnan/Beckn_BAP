...
import com.tibil.BecknBAP.controller.api.UpdateApi;
import com.tibil.BecknBAP.dto.beckn.InlineResponse200;
import com.tibil.BecknBAP.dto.internal.Update;
...
public class UpdateApiController implements UpdateApi {
    ...
    public ResponseEntity<InlineResponse200> updatePost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody Update body) {
