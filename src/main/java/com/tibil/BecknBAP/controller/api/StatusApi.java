...
public interface StatusApi {
    ...
    @Operation(summary = "", description = "Fetch the latest order object", security = {
...
@SecurityRequirement(name = "SubscriberAuth")    }, tags={ "Frontend Request" })
    ...
    ResponseEntity<InlineResponse200> statusPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody Status body);
