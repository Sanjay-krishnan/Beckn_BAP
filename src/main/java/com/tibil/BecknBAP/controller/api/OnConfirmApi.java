...
public interface OnConfirmApi {
    ...
    @Operation(summary = "", description = "Send active order object", security = {
...
@SecurityRequirement(name = "SubscriberAuth")    }, tags={ "Beckn App Platform (BAP)" })
    ...
    @RequestMapping(value = "/on_confirm",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<InlineResponse200> onConfirmPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody OnConfirmBody body);
