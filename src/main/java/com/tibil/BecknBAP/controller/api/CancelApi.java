...
public interface CancelApi {
    ...
    @Operation(summary = "", description = "Cancel an order", security = {
...
@SecurityRequirement(name = "SubscriberAuth")    }, tags={ "Frontend Request" })
    ...
    ResponseEntity<InlineResponse200> cancelPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody Cancel body);
