...
public interface OnTrackApi {
    ...
    @Operation(summary = "", description = "Send tracking details of an active order", security = {
...
@SecurityRequirement(name = "SubscriberAuth")    }, tags={ "Beckn App Platform (BAP)" })
    ...
    @RequestMapping(value = "/on_track",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<InlineResponse200> onTrackPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody OnTrackBody body);
