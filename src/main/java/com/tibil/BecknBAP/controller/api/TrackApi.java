...
public interface TrackApi {
    ...
    @Operation(summary = "", description = "Track an active order", security = {
...
@SecurityRequirement(name = "SubscriberAuth")    }, tags={ "Frontend Request" })
    ...
    ResponseEntity<InlineResponse200> trackPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody TrackBody body);
