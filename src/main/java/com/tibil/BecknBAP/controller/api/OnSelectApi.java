...
public interface OnSelectApi {
    ...
    @Operation(summary = "", description = "Send draft order object with quoted price for selected items", security = {
...
@SecurityRequirement(name = "SubscriberAuth")    }, tags={ "Beckn App Platform (BAP)" })
    ...
    @RequestMapping(value = "/on_select",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<InlineResponse200> onSelectPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody OnSelectBody body);
