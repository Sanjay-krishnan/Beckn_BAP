...
public interface ConfirmApi {
    ...
    @Operation(summary = "", description = "Initialize an order by providing billing and/or shipping details", security = {
...
@SecurityRequirement(name = "SubscriberAuth")    }, tags={ "Frontend Request" })
    ...
    ResponseEntity<InlineResponse200> confirmPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody Init body);
