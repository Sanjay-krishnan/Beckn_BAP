...
public interface OnStatusApi {
    ...
    @Operation(summary = "", description = "Fetch the status of a Service", security = {
...
@SecurityRequirement(name = "SubscriberAuth")    }, tags={ "Beckn App Platform (BAP)" })
    ...
    @RequestMapping(value = "/on_status",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<InlineResponse200> onStatusPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody OnStatusBody body);
