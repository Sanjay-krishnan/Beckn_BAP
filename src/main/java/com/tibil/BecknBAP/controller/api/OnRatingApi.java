...
public interface OnRatingApi {
    ...
    @Operation(summary = "", description = "Provide feedback on a service", security = {
...
@SecurityRequirement(name = "SubscriberAuth")    }, tags={ "Beckn App Platform (BAP)" })
    ...
    @RequestMapping(value = "/on_rating",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<InlineResponse200> onRatingPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody OnRatingBody body);
