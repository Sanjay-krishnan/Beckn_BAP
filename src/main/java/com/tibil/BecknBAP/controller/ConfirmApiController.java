...
import com.tibil.BecknBAP.controller.api.ConfirmApi;
...
public class ConfirmApiController implements ConfirmApi {
    ...
    public ResponseEntity<InlineResponse200> confirmPost(@Parameter(in = ParameterIn.DEFAULT, description = "TODO", schema=@Schema()) @Valid @RequestBody Init body) {
